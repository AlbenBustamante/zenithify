      ...
      <div class="w-full max-w-md">
        <div class="text-center mb-8">
          ...
          <p class="mt-2 text-sm text-gray-600">
            ¿No tienes cuenta?
            <a routerLink="/auth/register" class="font-medium text-primary-600 hover:text-primary-700">
              Regístrate gratis
            </a>
          </p>
        </div>
        ...
        <app-card>
          <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-5">
            ...
            <app-input
              ...
              type="password"
              placeholder="••••••••"
              [error]="form.controls['password'].invalid && form.controls['password'].touched ? 'Contraseña requerida' : ''"
            />
            ...
            <div class="flex items-center justify-between">
              ...
              <a routerLink="/auth/forgot-password" class="text-sm font-medium text-primary-600 hover:text-primary-700">
